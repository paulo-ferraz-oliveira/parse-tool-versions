...
;// CONCATENATED MODULE: ./src/parse_tool_versions.mjs




// These might turn into options one day
const dotToolVersionsPath = external_path_.join(process.env.GITHUB_WORKSPACE, '.tool-versions');
...
function parse() {
  if (!external_fs_.existsSync(dotToolVersionsPath)) {
